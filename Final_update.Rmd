...
Model55=glm(Gls~ leage + No.Pl+ SoT+PK+FK+Att.3rd.T+Succ.Drib+ ShortAT_Pass+NumAtt+ Succ.Drib:PK+Succ.Drib:FK, data1, family =quasipoisson())
...
```{r}
Model6=glm(Gls~ leage + No.Pl+ SoT+PK+FK+Att.3rd.T+Succ.Drib+ ShortAT_Pass+NumAtt+ Att.3rd.T:PK+Att.3rd.T:FK, data1, family =quasipoisson())
